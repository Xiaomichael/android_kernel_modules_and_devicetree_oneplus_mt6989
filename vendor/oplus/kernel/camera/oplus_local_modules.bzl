...
def define_oplus_local_modules():
    ...
    define_oplus_ddk_module(
        name = "oplus_camera_dw9800s_24780",
        srcs = native.glob([
            "**/*.h",
            "lens/vcm/v4l2/dw9800s_24780/dw9800s_24780.c",
        ]),
        includes = ["."],
    )
    ...
    define_oplus_ddk_module(
        name = "oplus_camera_jd5516w_24749",
        srcs = native.glob([
            "**/*.h",
            "lens/vcm/v4l2/jd5516w_24749/jd5516w_24749.c",
        ]),
        includes = ["."],
    )

    define_oplus_ddk_module(
        name = "oplus_camera_jd5516w_24769",
        srcs = native.glob([
            "**/*.h",
            "lens/vcm/v4l2/jd5516w_24769/jd5516w_24769.c",
        ]),
        includes = ["."],
    )

    define_oplus_ddk_module(
        name = "oplus_camera_jd5516w_24740",
        srcs = native.glob([
            "**/*.h",
            "lens/vcm/v4l2/jd5516w_24740/jd5516w_24740.c",
        ]),
        includes = ["."],
    )
    ...
    define_oplus_ddk_module(
        name = "oplus_camera_dw9800s_24891",
        srcs = native.glob([
            "**/*.h",
            "lens/vcm/v4l2/dw9800s_24891/dw9800s_24891.c",
        ]),
        includes = ["."],
    )

    define_oplus_ddk_module(
        name = "oplus_camera_dw9800s_24825",
        srcs = native.glob([
            "**/*.h",
            "lens/vcm/v4l2/dw9800s_24825/dw9800s_24825.c",
        ]),
        includes = ["."],
    )
    ...
    define_oplus_ddk_module(
        name = "oplus_camera_sy7806e_yamaha",
        srcs = native.glob([
            "**/*.h",
            "flashlight/v4l2/sy7806e_yamaha.c",
        ]),
        includes = ["."],
    )
    ...
    define_oplus_ddk_module(
        name = "oplus_camera_aw36515_2led_casioy",
        srcs = native.glob([
            "**/*.h",
            "flashlight/v4l2/aw36515_2led_casioy.c",
        ]),
        includes = ["."],
    )
    ...
    define_oplus_ddk_module(
        name = "oplus_camera_sy7806e_honda",
        srcs = native.glob([
            "**/*.h",
            "flashlight/v4l2/sy7806e_honda.c",
        ]),
        includes = ["."],
    )
    ...
    define_oplus_ddk_module(
        name = "oplus_camera_dw9800s_24622",
        srcs = native.glob([
            "**/*.h",
            "lens/vcm/v4l2/dw9800s_24622/dw9800s_24622.c",
        ]),
        includes = ["."],
    )
    ...
    ddk_copy_to_dist_dir(
        ...
        module_list = [
            ...
            "oplus_camera_jd5516w_24740",
            "oplus_camera_jd5516w_24749",
            "oplus_camera_jd5516w_24769",
            "oplus_camera_dw9800s_24622",
            "oplus_camera_temp",
        ],
    )

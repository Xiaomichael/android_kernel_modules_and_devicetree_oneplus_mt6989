...
#define ALPHAHFRONT_STEREO_START_ADDR            (0X2200)
#define ALPHAHFRONT_AESYNC_START_ADDR            (0x3800)
...
#define CASIOXMAIN_STEREO_START_ADDR            (0x2FBA)
#define CASIOXMAIN_AESYNC_START_ADDR            (0x3CF0)
#define CASIOXWIDE_STEREO_START_ADDR            (0x2E00)
#define CASIOXWIDE_AESYNC_START_ADDR            (0x348D)
#define CASIOXFRONT_STEREO_START_ADDR            (0X2200)
#define CASIOXFRONT_AESYNC_START_ADDR            (0x3800)
#define CASIOXFRONT2_STEREO_START_ADDR            (0X2200)
#define CASIOXFRONT2_AESYNC_START_ADDR            (0x3800)

#define CASIOYMAIN_STEREO_START_ADDR            (0x2FBA)
#define CASIOYMAIN_AESYNC_START_ADDR            (0x3CF0)
#define CASIOYFRONT_STEREO_START_ADDR            (0X2200)
#define CASIOYFRONT_AESYNC_START_ADDR            (0x3800)
#define CASIOPFRONT_STEREO_START_ADDR            (0X2200)
#define CASIOPFRONT_AESYNC_START_ADDR            (0x3800)

#define IWCMAIN_STEREO_START_ADDR            (0x2FBA)
#define IWCMAIN_AESYNC_START_ADDR            (0x3CF0)
#define IWCFRONT_STEREO_START_ADDR            (0X2200)
#define IWCFRONT_AESYNC_START_ADDR            (0x3800)

#define CAYMANAMAIN_STEREO_START_ADDR          (0x2B00)
#define CAYMANAMAIN_STEREO_MT_START_ADDR       (0x31C0)
#define CAYMANAMAIN_STEREO_MT_105CM_START_ADDR (0x6400)
#define CAYMANAMAIN_AESYNC_START_ADDR          (0x3880)
#define CAYMANAFRONT_STEREO_START_ADDR         (0X2200)
#define CAYMANAFRONT_AESYNC_START_ADDR         (0x3800)

#define SUBARUFRONT_STEREO_START_ADDR         (0X2200)
#define SUBARUFRONT_AESYNC_START_ADDR         (0x3800)


#define CAYMANBMAIN_STEREO_START_ADDR          (0x2B00)
#define CAYMANBMAIN_STEREO_MT_START_ADDR       (0x31C0)
#define CAYMANBMAIN_STEREO_MT_105CM_START_ADDR (0x6400)
#define CAYMANBMAIN_AESYNC_START_ADDR          (0x3880)
#define CAYMANBFRONT_STEREO_START_ADDR         (0X2200)
#define CAYMANBFRONT_AESYNC_START_ADDR         (0x3800)

#define CAYMANBNMAIN_STEREO_START_ADDR          (0x2B00)
#define CAYMANBNMAIN_STEREO_MT_START_ADDR       (0x31C0)
#define CAYMANBNMAIN_STEREO_MT_105CM_START_ADDR (0x6400)
#define CAYMANBNMAIN_AESYNC_START_ADDR          (0x3880)
#define CAYMANBNFRONT_STEREO_START_ADDR         (0X2200)
#define CAYMANBNFRONT_AESYNC_START_ADDR         (0x3800)
#define CAYMANBNFRONT2_STEREO_START_ADDR         (0X2200)
#define CAYMANBNFRONT2_AESYNC_START_ADDR         (0x3800)

#define CAYMANPMAIN_STEREO_START_ADDR          (0x2B00)
#define CAYMANPMAIN_STEREO_MT_START_ADDR       (0x31C0)
#define CAYMANPMAIN_STEREO_MT_105CM_START_ADDR (0x6400)
#define CAYMANPMAIN_AESYNC_START_ADDR          (0x3880)
#define CAYMANPFRONT_STEREO_START_ADDR         (0X2200)
#define CAYMANPFRONT_AESYNC_START_ADDR         (0x3800)
#define CAYMANPFRONT2_STEREO_START_ADDR         (0X2200)
#define CAYMANPFRONT2_AESYNC_START_ADDR         (0x3800)

#define CAYMANCMAIN_STEREO_START_ADDR          (0x2B00)
#define CAYMANCMAIN_STEREO_MT_START_ADDR       (0x31C0)
#define CAYMANCMAIN_STEREO_MT_105CM_START_ADDR (0x6400)
#define CAYMANCMAIN_AESYNC_START_ADDR          (0x3880)
#define CAYMANCFRONT_STEREO_START_ADDR         (0X2200)
#define CAYMANCFRONT_AESYNC_START_ADDR         (0x3800)

#define BAIKALMFRONT_STEREO_START_ADDR            (0X2200)
#define BAIKALMFRONT_AESYNC_START_ADDR            (0x3800)
#define BAIKALMFRONT2_STEREO_START_ADDR            (0X2200)
#define BAIKALMFRONT2_AESYNC_START_ADDR            (0x3800)
#define BAIKALMFRONT3_STEREO_START_ADDR            (0X2200)
#define BAIKALMFRONT3_AESYNC_START_ADDR            (0x3800)
...
struct SENSOR_OTP_INFO_STRUCT {
        ...
        MUINT8 isAFCodeOffset;
        MUINT8 AFLeftOffsetLen;
        MUINT8 AFRightOffsetLen;
};

struct SENSOR_OIS_OTP_STRUCT
{
        MUINT32 multi_golden_addr_offset;
        MUINT32 multi_golden_size;
        MUINT32 multi_golden_valid_offset;
        MUINT32 gradient_uint8_offset;
        MUINT32 gradient_float_offset;
        MUINT32 ois_calibration_offset;
        MUINT32 ois_calibration_size;
        MUINT32 ois_calibration_valid_offset;
        MUINT32 ois_calibration_index_num;
        MUINT32 ois_calibration_table_num;
        MUINT32 is_ois_otp_data_exist;
};
...
#define OPLUS_EXTERN_ACDK_SENSOR_FEATURE_ENUM    \
        ...
        SENSOR_FEATURE_SET_AF_CODE_DATA, \
        SENSOR_FEATURE_GET_OIS_COMPENSATION, \
        SENSOR_FEATURE_GET_OIS_OTP_INFO

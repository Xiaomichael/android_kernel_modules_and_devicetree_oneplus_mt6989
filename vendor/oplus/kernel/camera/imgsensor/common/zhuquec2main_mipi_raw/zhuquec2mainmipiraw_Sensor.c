 ...
 *============================================================================
 ****************************************************************************/
#include "zhuquec2mainmipiraw_Sensor.h"
#define SENSOR_NAME  SENSOR_DRVNAME_ZHUQUEC2MAIN_MIPI_RAW
#define ZHUQUEC2MAIN_EEPROM_READ_ID	0xA1
#define ZHUQUEC2MAIN_EEPROM_WRITE_ID	0xA0
#define OPLUS_CAMERA_COMMON_DATA_LENGTH 40
#define PFX "zhuquec2main_camera_sensor"
...
#define ZHUQUEC2MAIN_STEREO_START_ADDR   (0x2FBA)
#define ZHUQUEC2MAIN_AESYNC_START_ADDR   (0x3CF0)

#define QSC_TYPE               (0x01)
#define LRC_TYPE               (0x02)
#define ZHUQUEC2MAIN_UNIQUE_SENSOR_ID_ADDR 0x3AE8
#define ZHUQUEC2MAIN_UNIQUE_SENSOR_ID_LENGTH 13

static BYTE zhuquec2main_unique_id[ZHUQUEC2MAIN_UNIQUE_SENSOR_ID_LENGTH] = { 0 };
...
static int zhuquec2main_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int zhuquec2main_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int zhuquec2main_check_sensor_id(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int zhuquec2main_get_sensor_sn(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int get_eeprom_common_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int zhuquec2main_set_eeprom_calibration(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int zhuquec2main_get_eeprom_calibration(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int zhuquec2main_get_otp_checksum_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int zhuquec2main_get_min_shutter_by_scenario_adapter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
static int open(struct subdrv_ctx *ctx);
static int init_ctx(struct subdrv_ctx *ctx,	struct i2c_client *i2c_client, u8 i2c_write_id);
static int vsync_notify(struct subdrv_ctx *ctx,	unsigned int sof_cnt);
static int zhuquec2main_set_awb_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static int zhuquec2main_get_unique_sensorid(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int zhuquec2main_set_cali_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int zhuquec2main_get_cloud_otp_info(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static void calculate_prsh_length_lines(struct subdrv_ctx *ctx, struct mtk_hdr_ae *ae_ctrl, enum SENSOR_SCENARIO_ID_ENUM scenario_id);
/* STRUCT */

static BYTE zhuquec2main_common_data[OPLUS_CAMERA_COMMON_DATA_LENGTH] = { 0 };
...
static struct comp_mode_tran_time_params zhuquec2main_comp_params[SENSOR_SCENARIO_ID_MAX] = {
	{ .enable = 0, }, /*pre*/
...
static struct eeprom_map_info zhuquec2main_eeprom_info[] = {
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, zhuquec2main_set_test_pattern},
	{SENSOR_FEATURE_SEAMLESS_SWITCH, zhuquec2main_seamless_switch},
	{SENSOR_FEATURE_CHECK_SENSOR_ID, zhuquec2main_check_sensor_id},
	{SENSOR_FEATURE_GET_EEPROM_DATA, zhuquec2main_get_sensor_sn},
	{SENSOR_FEATURE_GET_EEPROM_COMDATA, get_eeprom_common_data},
	{SENSOR_FEATURE_SET_SENSOR_OTP, zhuquec2main_set_eeprom_calibration},
	{SENSOR_FEATURE_GET_EEPROM_STEREODATA, zhuquec2main_get_eeprom_calibration},
	{SENSOR_FEATURE_GET_SENSOR_OTP_ALL, zhuquec2main_get_otp_checksum_data},
	{SENSOR_FEATURE_GET_MIN_SHUTTER_BY_SCENARIO, zhuquec2main_get_min_shutter_by_scenario_adapter},
	{SENSOR_FEATURE_SET_AWB_GAIN, zhuquec2main_set_awb_gain},
	{SENSOR_FEATURE_GET_UNIQUE_SENSORID, zhuquec2main_get_unique_sensorid},
	{SENSOR_FEATURE_SET_CALI_DATA, zhuquec2main_set_cali_data},
	{SENSOR_FEATURE_GET_CLOUD_OTP_INFO, zhuquec2main_get_cloud_otp_info},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	{/*Reg_A_QBIN(VBIN)_4096x3072_30FPS with PDAF VB_max*/
		...
		.mode_setting_table = zhuquec2main_preview_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_preview_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = zhuquec2main_seamless_normal_preview,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(zhuquec2main_seamless_normal_preview),
		.hdr_mode = HDR_NONE,
		.pclk = 878400000,
		.linelength = 7500,
		.framelength = 3900,
		.max_framerate = 300,
		.mipi_pixel_rate = 1471540000,
		.readout_length = 0,
		.read_margin = 10,
		.framelength_step = 4,
		.coarse_integ_step = 4,
	...
	{/*Reg_A_QBIN(VBIN)_4096x3072_30FPS with PDAF VB_max*/
		...
		.mode_setting_table = zhuquec2main_capture_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_capture_setting),
	...
	{/*Reg_B_4096x2304_30FPS**/
		...
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_normal_video_setting),
		.seamless_switch_group = 3,
		.seamless_switch_mode_setting_table = zhuquec2main_seamless_normal_video,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(zhuquec2main_seamless_normal_video),
		.hdr_mode = HDR_NONE,
		.pclk = 878400000,
		.linelength = 7500,
		.framelength = 3900,
    ...
    {/*Reg_B_4096x2304_30FPS**/
		...
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
    ...
    {/*Reg_B_4096x2304_30FPS**/
		...
		.mode_setting_table = zhuquec2main_slim_video_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_slim_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
    ...
    {/*Reg_B_4096x2304_30FPS**/
		...
		.mode_setting_table = zhuquec2main_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_custom1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
    ...
    {/*Reg_A-1_QBIN(VBIN)_4096x3072_24FPS with PDAF VB_max**/
		...
		.mode_setting_table = zhuquec2main_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_custom2_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = zhuquec2main_seamless_custom2,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(zhuquec2main_seamless_custom2),
		.hdr_mode = HDR_NONE,
		.pclk = 878400000,
		.linelength = 7500,
		.framelength = 4876,
    ...
    {/*Reg_B_4096x2304_30FPS**/
		...
		.mode_setting_table = zhuquec2main_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_custom3_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
    ...
    {/*F9-S4_4096x3072_30FPS_IZOOM+QBC**/
		...
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_custom4_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = zhuquec2main_seamless_custom4,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(zhuquec2main_seamless_custom4),
		.hdr_mode = HDR_NONE,
		.pclk = 878400000,
		.linelength = 8960,
		.framelength = 3252,
    ...
    {/*F10-S1_4096x3072_24FPS_IZOOM+QBC**/
		.frame_desc = frame_desc_cus5,
		.num_entries = ARRAY_SIZE(frame_desc_cus5),
		.mode_setting_table = zhuquec2main_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_custom5_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = zhuquec2main_seamless_custom5,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(zhuquec2main_seamless_custom5),
		.hdr_mode = HDR_NONE,
		.pclk = 878400000,
		.linelength = 8960,
		.framelength = 4064,
    ...
    {/*Reg_F12-S6_4096x2304_30FPS**/
		.frame_desc = frame_desc_cus6,
		.num_entries = ARRAY_SIZE(frame_desc_cus6),
		.mode_setting_table = zhuquec2main_custom6_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_custom6_setting),
		.seamless_switch_group = 3,
		.seamless_switch_mode_setting_table = zhuquec2main_seamless_custom6,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(zhuquec2main_seamless_custom6),
		.hdr_mode = HDR_NONE,
		.pclk = 878400000,
		.linelength = 8960,
		.framelength = 3252,
    ...
    {/* reg_L6-S6 */
		...
		.mode_setting_table = zhuquec2main_custom7_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_custom7_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = zhuquec2main_seamless_custom7,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(zhuquec2main_seamless_custom7),
    ...
    {/*Reg_B18_1920x1440 @24FPS QBIN(VBIN) VB_MAX (LLP 7500)**/
		.frame_desc = frame_desc_cus8,
		.num_entries = ARRAY_SIZE(frame_desc_cus8),
		.mode_setting_table = zhuquec2main_custom8_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_custom8_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
    ...
    {/*Reg_B16-S6_4096x2048 @30FPS QBIN(VBIN) VB_MAX 2146M**/
		.frame_desc = frame_desc_cus9,
		.num_entries = ARRAY_SIZE(frame_desc_cus9),
		.mode_setting_table = zhuquec2main_custom9_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_custom9_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
    ...
    {/*Reg_B17-S6_2048x1024 @30FPS QBIN(VBIN)-V2H2 VB_MAX 2146M**/
		.frame_desc = frame_desc_cus10,
		.num_entries = ARRAY_SIZE(frame_desc_cus10),
		.mode_setting_table = zhuquec2main_custom10_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_custom10_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
    ...
    {/*Reg_B_4096x2304_30FPS**/
		...
		.mode_setting_table = zhuquec2main_custom11_setting,
		.mode_setting_len = ARRAY_SIZE(zhuquec2main_custom11_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = ZHUQUEC2MAIN_SENSOR_ID,
	...
	.ana_gain_type = 0,
	.ana_gain_step = 1,
	.ana_gain_table = zhuquec2main_ana_gain_table,
	.ana_gain_table_size = sizeof(zhuquec2main_ana_gain_table),
	.min_gain_iso = 100,
	.exposure_def = 0x3D0,
	.exposure_min = 6,
	...
	.init_setting_table = zhuquec2main_init_setting,
	.init_setting_len = ARRAY_SIZE(zhuquec2main_init_setting),
	.mode = mode_struct,
...
struct subdrv_entry zhuquec2main_mipi_raw_entry = {
	.name = SENSOR_NAME,
	.id = ZHUQUEC2MAIN_SENSOR_ID,
	.pw_seq = pw_seq,
...
static unsigned int read_zhuquec2main_eeprom_info(struct subdrv_ctx *ctx, kal_uint16 meta_id,
	BYTE *data, int size)
{
	kal_uint16 addr;
	int readsize;

	if (meta_id != zhuquec2main_eeprom_info[meta_id].meta)
		return -1;

	if (size != zhuquec2main_eeprom_info[meta_id].size)
		return -1;

	addr = zhuquec2main_eeprom_info[meta_id].start;
	readsize = zhuquec2main_eeprom_info[meta_id].size;
...
static struct SENSOR_OTP_INFO_STRUCT cloud_otp_info[OPLUS_CAM_CAL_DATA_MAX] = {
	...
	{
		.OtpInfoLen = 4,
		.OtpInfo = {{0x17D0, 976}, {0x1BB0, 1624}, {0x33A0, 496}, {0x35A0, 1004}},
...
static int zhuquec2main_get_sensor_sn(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	memcpy(feature_return_para_32, zhuquec2main_common_data,
...
static kal_uint16 read_cmos_eeprom_8(struct subdrv_ctx *ctx, kal_uint16 addr)
{
	...
	adaptor_i2c_rd_u8(ctx->i2c_client, ZHUQUEC2MAIN_EEPROM_READ_ID >> 1, addr, (u8 *)&get_byte);
	return get_byte;
}
        ...
        kal_uint16 addr, kal_uint8 *para, kal_uint32 len)
{
    ...
    ret = adaptor_i2c_wr_p8(ctx->i2c_client, ZHUQUEC2MAIN_EEPROM_WRITE_ID >> 1,
            addr, para, len);
...
static kal_int32 write_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    ...
    if (enable) {
        adaptor_i2c_wr_u8(ctx->i2c_client, ZHUQUEC2MAIN_EEPROM_READ_ID >> 1, reg, (ZHUQUEC2MAIN_EEPROM_WRITE_ID & 0xFE) | 0x01);
    }
    else {
        adaptor_i2c_wr_u8(ctx->i2c_client, ZHUQUEC2MAIN_EEPROM_READ_ID >> 1, reg, ZHUQUEC2MAIN_EEPROM_WRITE_ID & 0xFE);
    }
    ...
    ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == ZHUQUEC2MAIN_SENSOR_ID || pStereodata->uSensorId == ZHUQUES2MAIN_SENSOR_ID)
            && (data_length == CALI_DATA_SLAVE_LENGTH) && (data_base == ZHUQUEC2MAIN_STEREO_START_ADDR )) {
            ...
            */
        } else if ((pStereodata->uSensorId == ZHUQUEC2MAIN_SENSOR_ID || pStereodata->uSensorId == ZHUQUES2MAIN_SENSOR_ID)
            && (data_length < AESYNC_DATA_LENGTH_TOTAL) && (data_base == ZHUQUEC2MAIN_AESYNC_START_ADDR)) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                read_cmos_eeprom_8(ctx, ZHUQUEC2MAIN_AESYNC_START_ADDR),
                read_cmos_eeprom_8(ctx, ZHUQUEC2MAIN_AESYNC_START_ADDR+1),
                read_cmos_eeprom_8(ctx, ZHUQUEC2MAIN_AESYNC_START_ADDR+2),
                read_cmos_eeprom_8(ctx, ZHUQUEC2MAIN_AESYNC_START_ADDR+3),
                read_cmos_eeprom_8(ctx, ZHUQUEC2MAIN_AESYNC_START_ADDR+4),
                read_cmos_eeprom_8(ctx, ZHUQUEC2MAIN_AESYNC_START_ADDR+5),
                read_cmos_eeprom_8(ctx, ZHUQUEC2MAIN_AESYNC_START_ADDR+6),
                read_cmos_eeprom_8(ctx, ZHUQUEC2MAIN_AESYNC_START_ADDR+7));
        ...
        LOG_INF("zhuquec2main write_Module_data pStereodata is null\n");
        return -1;
    }
    return ret;
}
...
static int zhuquec2main_get_eeprom_calibration(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
    ...
    read_zhuquec2main_eeprom_info(ctx, EEPROM_META_STEREO_DATA,
            (BYTE *)para, *len);
	return 0;
}
...
static bool read_cmos_eeprom_p8(struct subdrv_ctx *ctx, kal_uint16 addr,
                    BYTE *data, int size)
{
	if (adaptor_i2c_rd_p8(ctx->i2c_client, ZHUQUEC2MAIN_EEPROM_READ_ID >> 1,
			addr, data, size) < 0) {
		return false;
	}
	return true;
...
{
	DRV_LOGE(ctx, "zhuquec2main read_otp_info begin\n");
	read_cmos_eeprom_p8(ctx, 0, otp_data_checksum, OTP_SIZE);
	DRV_LOGE(ctx, "zhuquec2main read_otp_info end\n");
}
...
{
	u32 *feature_return_para_32 = (u32 *)para;
	*len = ZHUQUEC2MAIN_UNIQUE_SENSOR_ID_LENGTH;
	memcpy(feature_return_para_32, zhuquec2main_unique_id,
		ZHUQUEC2MAIN_UNIQUE_SENSOR_ID_LENGTH);
...
static void read_unique_sensorid(struct subdrv_ctx *ctx)
{
	...
	while (ctx->s_ctx.i2c_addr_table[i] != 0xFF) {
		...
		if (adaptor_i2c_rd_p8(ctx->i2c_client, ctx->i2c_write_id >> 1, ZHUQUEC2MAIN_UNIQUE_SENSOR_ID_ADDR,
			&(zhuquec2main_unique_id[0]), ZHUQUEC2MAIN_UNIQUE_SENSOR_ID_LENGTH) < 0) {
...
static u16 zhuquec2main_feedback_awbgain[] = {
	0x0B8E, 0x01,
	0x0B8F, 0x00,
	0x0B90, 0x02,
	0x0B91, 0x28,
...
static void feedback_awbgain(struct subdrv_ctx *ctx, kal_uint32 r_gain, kal_uint32 b_gain)
{
	...
	if (ctx->current_scenario_id == SENSOR_SCENARIO_ID_CUSTOM3 || // RMSC
			...
			ctx->current_scenario_id == SENSOR_SCENARIO_ID_CUSTOM6) { // QRMSC
		DRV_LOG(ctx, "feedback_awbgain r_gain: %d, b_gain: %d\n", r_gain, b_gain);
		r_gain_int = r_gain / 512;
		b_gain_int = b_gain / 512;
		zhuquec2main_feedback_awbgain[5] = r_gain_int;
		zhuquec2main_feedback_awbgain[7] = (r_gain - r_gain_int * 512) / 2;
		zhuquec2main_feedback_awbgain[9] = b_gain_int;
		zhuquec2main_feedback_awbgain[11] = (b_gain - b_gain_int * 512) / 2;
		subdrv_i2c_wr_regs_u8(ctx, zhuquec2main_feedback_awbgain,
			ARRAY_SIZE(zhuquec2main_feedback_awbgain));
	}
}
...
void zhuquec2main_get_min_shutter_by_scenario(struct subdrv_ctx *ctx,
...
int zhuquec2main_get_min_shutter_by_scenario_adapter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	u64 *feature_data = (u64 *) para;
	zhuquec2main_get_min_shutter_by_scenario(ctx,
	...
	enum SENSOR_SCENARIO_ID_ENUM pre_seamless_scenario_id)
{
	...
	if (pre_seamless_scenario_id == SENSOR_SCENARIO_ID_NORMAL_PREVIEW && scenario_id == SENSOR_SCENARIO_ID_CUSTOM7) {
		prsh_length_lc = 1150;
		...
		prsh_length_lc = 1600;
	} else if (pre_seamless_scenario_id == SENSOR_SCENARIO_ID_CUSTOM4 && scenario_id == SENSOR_SCENARIO_ID_CUSTOM7) {
		prsh_length_lc = 50;
	} else {
		prsh_length_lc = 0;
	}
...
static int vsync_notify(struct subdrv_ctx *ctx,	unsigned int sof_cnt)
{
	DRV_LOGE(ctx, "sof_cnt(%u) ctx->ref_sof_cnt(%u) ctx->fast_mode_on(%d)",
...
static int zhuquec2main_set_cali_data(struct subdrv_ctx *ctx, u8 *para, u32 *len) {
	...
	u8 *buf = NULL;
	u32 size = 0;
	u8 qsc_is_valid = 0, pdc_is_valid = 0;
	u8 type = 0;
	struct eeprom_info_struct *info = ctx->s_ctx.eeprom_info;

	if (ctx->is_read_preload_eeprom >= 3) {
        return 0;
	}
	type = para[(*len) + 1];
	if (type == QSC_TYPE) {
...
static void comp_mode_tran_time_cal1(struct subdrv_ctx *ctx, u32 scenario_id, u32* prsh) {
	...
	*prsh = 0U;
	if (zhuquec2main_comp_params[ctx->current_scenario_id].clock_vtpxck == 0) {
	...
	system_delay = SYSTEM_DELAY1 * 1000 * 1000 * 10 /
		zhuquec2main_comp_params[ctx->current_scenario_id].clock_vtpxck;
...
static void get_imgsensor_id_from_dts(struct subdrv_ctx *ctx, u32 *sensor_id) {
	struct subdrv_entry *m_subdrv_entry = &zhuquec2main_mipi_raw_entry;

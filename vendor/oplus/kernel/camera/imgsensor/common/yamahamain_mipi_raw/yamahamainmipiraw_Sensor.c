 ...
 *============================================================================
 ****************************************************************************/
#include "yamahamainmipiraw_Sensor.h"

#define YAMAHAMAIN_EEPROM_READ_ID	0xA1
#define YAMAHAMAIN_EEPROM_WRITE_ID	0xA0
#define YAMAHAMAIN_MAX_OFFSET		0x8000
...
#define YAMAHAMAIN_STEREO_START_ADDR          (0x2B00)
#define YAMAHAMAIN_STEREO_MT_START_ADDR       (0x31C0)
#define YAMAHAMAIN_STEREO_MT_105CM_START_ADDR (0x6400)
#define YAMAHAMAIN_AESYNC_START_ADDR          (0x3880)
...
static int yamahamain_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int yamahamain_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int yamahamain_check_sensor_id(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int get_eeprom_common_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int yamahamain_set_eeprom_calibration(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int yamahamain_get_eeprom_calibration(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int yamahamain_get_otp_checksum_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int yamahamain_get_min_shutter_by_scenario_adapter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
static int open(struct subdrv_ctx *ctx);
static int init_ctx(struct subdrv_ctx *ctx,	struct i2c_client *i2c_client, u8 i2c_write_id);
static int vsync_notify(struct subdrv_ctx *ctx,	unsigned int sof_cnt);
static int yamahamain_set_awb_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, yamahamain_set_test_pattern},
	{SENSOR_FEATURE_SEAMLESS_SWITCH, yamahamain_seamless_switch},
	{SENSOR_FEATURE_CHECK_SENSOR_ID, yamahamain_check_sensor_id},
	{SENSOR_FEATURE_GET_EEPROM_COMDATA, get_eeprom_common_data},
	{SENSOR_FEATURE_SET_SENSOR_OTP, yamahamain_set_eeprom_calibration},
	{SENSOR_FEATURE_GET_EEPROM_STEREODATA, yamahamain_get_eeprom_calibration},
	{SENSOR_FEATURE_GET_SENSOR_OTP_ALL, yamahamain_get_otp_checksum_data},
	{SENSOR_FEATURE_GET_MIN_SHUTTER_BY_SCENARIO, yamahamain_get_min_shutter_by_scenario_adapter},
...
static struct subdrv_mode_struct mode_struct[] = {
	{/*reg_B2-S1_QBIN(VBIN)_4096x3072_30fps*/
		...
		.mode_setting_table = yamahamain_preview_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_preview_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = yamahamain_seamless_preview,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_preview),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 1360000000,
	...
	{/*reg_B2-S1_QBIN(VBIN)_4096x3072_30fps*/
		...
		.mode_setting_table = yamahamain_capture_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_capture_setting),
	...
	{/*reg_B4-S3_4096x2304_30FPS**/
		...
		.mode_setting_table = yamahamain_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_normal_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = yamahamain_seamless_normal_video,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_normal_video),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 1360000000,
	...
	{/*reg_B5-S3  4096x2304 @60FPS */
		...
		.mode_setting_table = yamahamain_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = yamahamain_seamless_hs_video,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_hs_video),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 1360000000,
	...
	{   /*reg_V1  2048x1152 @120FPS.*/
		...
		.mode_setting_table = yamahamain_slim_video_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_slim_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/*reg_V2 2048x1152 @240FPS QBIN V2H2 w/o PD VB Max*/
		...
		.mode_setting_table = yamahamain_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/*B1-S2 4096x3072 @24FPS QBIN(VBIN) w/ All-PD VB Max. Seamless F3-S2*/
		.frame_desc = frame_desc_cus2,
		.num_entries = ARRAY_SIZE(frame_desc_cus2),
		.mode_setting_table = yamahamain_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom2_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = yamahamain_seamless_custom2,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_custom2),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 1360000000,
	...
	{/*reg_B6-S3  4096x2304 @30FPS QBIN w/ Partial-PD VB Max. Seamless w/ "*-S3"**/
		...
		.mode_setting_table = yamahamain_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom3_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = yamahamain_seamless_custom3,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_custom3),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 1360000000,
	...
	{/*reg_L1-S1 4096x3072 @30FPS QBIN 2LB-MF w/ Partial-PD VB Max. Seamless w/ "*-S1"*/
		...
		.mode_setting_table = yamahamain_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom4_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = yamahamain_seamless_custom4,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_custom4),
	...
	{/*reg_F2-S1 4096x3072 @30FPS Full-Crop w/ PD VB Max. Seamless w/  "*-S1"*/
		...
		.mode_setting_table = yamahamain_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom5_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = yamahamain_seamless_custom5,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_custom5),
		.hdr_mode = HDR_NONE,
		.pclk = 1360000000,
		.linelength = 14032,
		.framelength = 3225,
	...
	{/*reg_L2-S1 4096x3072 @15FPS Full RMSC 2LB-MF w/ All-PD VB Max. Seamless w/ "*-S1"*/
		...
		.mode_setting_table = yamahamain_custom6_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom6_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = yamahamain_seamless_custom6,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_custom6),
		.hdr_mode = HDR_RAW_LBMF,
		.raw_cnt = 2,
		.exp_cnt = 2,
		.pclk = 1360000000,
	...
	{/*reg_G1-S3  4096x2304 @30FPS QBIN DAG1:4 w/ Partial-PD VB Max. Seamless w/ "*-S3"*/
		...
		.mode_setting_table = yamahamain_custom7_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom7_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		...
		.dcg_info = {
			...
			.dcg_gain_table = yamahamain_dcg_ratio_table_ratio4,
			.dcg_gain_table_size = sizeof(yamahamain_dcg_ratio_table_ratio4),
		},
		.sensor_setting_info = {
			.sensor_scenario_usage = UNUSE_MASK,
			.equivalent_fps = 30,
	...
	{/*reg_F1 8192x6144 @15FPS Full RMSC w/ PD VB Max.*/
		...
		.mode_setting_table = yamahamain_custom8_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom8_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/*reg_F1-RAW 8192x6144 @15FPS Full-RAW w/ PD VB Max.*/
		...
		.mode_setting_table = yamahamain_custom9_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom9_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/*reg_F2-RAW-S1 4096x3072 @30FPS Full-RAW-Crop w/ PD VB Max.*/
		...
		.mode_setting_table = yamahamain_custom10_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom10_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = yamahamain_seamless_custom10,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_custom10),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 1360000000,
    ...
    {/*F3-S2 4096x3072 @24FPS Full-Crop w/ PD VB Max. Seamless B1-S2*/
		.frame_desc = frame_desc_cus11,
		.num_entries = ARRAY_SIZE(frame_desc_cus11),
		.mode_setting_table = yamahamain_custom11_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom11_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = yamahamain_seamless_custom11,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_custom11),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 1360000000,
	...
	{/*reg_L2-RAW-S1 4096x3072 @15FPS Full-RAW 2LB-MF w/ All-PD VB Max*/
		...
		.mode_setting_table = yamahamain_custom12_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom12_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = yamahamain_seamless_custom12,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_custom12),
		.hdr_mode = HDR_RAW_LBMF,
		.raw_cnt = 2,
		.exp_cnt = 2,
		.pclk = 1360000000,
	...
	{/*reg_V3 2048x1536 @24FPS QBIN V2H2 w/o PD VB Max.*/
		...
		.mode_setting_table = yamahamain_custom13_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom13_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/*reg_B3-S1 4096x3072 @60FPS QBIN w/ Partial-PD VB Max.*/
		...
		.mode_setting_table = yamahamain_custom14_setting,
		.mode_setting_len = ARRAY_SIZE(yamahamain_custom14_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = yamahamain_seamless_custom14,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(yamahamain_seamless_custom14),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 1360000000,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = YAMAHAMAIN_SENSOR_ID,
	...
	.ana_gain_type = 0,
	.ana_gain_step = 1,
	.ana_gain_table = yamahamain_ana_gain_table,
	.ana_gain_table_size = sizeof(yamahamain_ana_gain_table),
	.min_gain_iso = 100,
	.exposure_def = 0x3D0,
	.exposure_min = 6,
	...
	.init_setting_table = yamahamain_init_setting,
	.init_setting_len = ARRAY_SIZE(yamahamain_init_setting),
	.mode = mode_struct,
...
const struct subdrv_entry yamahamain_mipi_raw_entry = {
	.name = "yamahamain_mipi_raw",
	.id = YAMAHAMAIN_SENSOR_ID,
	.pw_seq = pw_seq,
...
static unsigned int read_yamahamain_eeprom_info(struct subdrv_ctx *ctx, kal_uint16 meta_id,
	BYTE *data, int size)
{
	kal_uint16 addr;
	int readsize;

	if (meta_id != yamahamain_eeprom_info[meta_id].meta)
		return -1;

	if (size != yamahamain_eeprom_info[meta_id].size)
		return -1;

	addr = yamahamain_eeprom_info[meta_id].start;
	readsize = yamahamain_eeprom_info[meta_id].size;
...
static kal_uint16 read_cmos_eeprom_8(struct subdrv_ctx *ctx, kal_uint16 addr)
{
	...
	adaptor_i2c_rd_u8(ctx->i2c_client, YAMAHAMAIN_EEPROM_READ_ID >> 1, addr, (u8 *)&get_byte);
	return get_byte;
}
        ...
        kal_uint16 addr, kal_uint8 *para, kal_uint32 len)
{
	...
	ret = adaptor_i2c_wr_p8(ctx->i2c_client, YAMAHAMAIN_EEPROM_WRITE_ID >> 1,
			addr, para, len);
...
static kal_int32 write_1st_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
	...
	adaptor_i2c_wr_u8(ctx->i2c_client, (0xB0 | YAMAHAMAIN_EEPROM_WRITE_ID) >> 1, reg, 0x0);

	reg = 0x06ca;
	if (enable) {
		adaptor_i2c_wr_u8(ctx->i2c_client, (0xB0 | YAMAHAMAIN_EEPROM_WRITE_ID) >> 1, reg, 0x2);
	}
	else {
		adaptor_i2c_wr_u8(ctx->i2c_client, (0xB0 | YAMAHAMAIN_EEPROM_WRITE_ID) >> 1, reg, 0x0);
	}

	adaptor_i2c_rd_u8(ctx->i2c_client, YAMAHAMAIN_EEPROM_WRITE_ID >> 1, reg, &flag);
...
static kal_int32 write_2nd_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
	...
	if (enable) {
		adaptor_i2c_wr_u8(ctx->i2c_client, YAMAHAMAIN_EEPROM_WRITE_ID >> 1, reg, 0x0E);
	}
	else {
		adaptor_i2c_wr_u8(ctx->i2c_client, YAMAHAMAIN_EEPROM_WRITE_ID >> 1, reg, 0x00);
	}
...
static kal_int32 write_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
	u8 flag = 0;
	int ret = 0;
	adaptor_i2c_rd_u8(ctx->i2c_client, YAMAHAMAIN_EEPROM_READ_ID >> 1, 0x000D, &flag);
	if (flag == 0x01) {
	...
	ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == YAMAHAMAIN_SENSOR_ID) && (data_length == CALI_DATA_MASTER_LENGTH)
				&& (data_base == YAMAHAMAIN_STEREO_START_ADDR || data_base == YAMAHAMAIN_STEREO_MT_START_ADDR
				|| data_base == YAMAHAMAIN_STEREO_MT_105CM_START_ADDR)) {
		...
		} else if ((pStereodata->uSensorId == YAMAHAMAIN_SENSOR_ID) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
				&& (data_base == YAMAHAMAIN_AESYNC_START_ADDR)) {
			...
			LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
				read_cmos_eeprom_8(ctx, YAMAHAMAIN_AESYNC_START_ADDR),
				read_cmos_eeprom_8(ctx, YAMAHAMAIN_AESYNC_START_ADDR+1),
				read_cmos_eeprom_8(ctx, YAMAHAMAIN_AESYNC_START_ADDR+2),
				read_cmos_eeprom_8(ctx, YAMAHAMAIN_AESYNC_START_ADDR+3),
				read_cmos_eeprom_8(ctx, YAMAHAMAIN_AESYNC_START_ADDR+4),
				read_cmos_eeprom_8(ctx, YAMAHAMAIN_AESYNC_START_ADDR+5),
				read_cmos_eeprom_8(ctx, YAMAHAMAIN_AESYNC_START_ADDR+6),
				read_cmos_eeprom_8(ctx, YAMAHAMAIN_AESYNC_START_ADDR+7));
		...
		LOG_INF("yamahamain write_Module_data pStereodata is null\n");
		return -1;
	}
	return ret;
}
...
static int yamahamain_get_eeprom_calibration(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	case EEPROM_STEREODATA_MT_MAIN:
		read_yamahamain_eeprom_info(ctx, EEPROM_META_STEREO_MT_MAIN_DATA,
				(BYTE *)feature_return_para_32, *len);
		break;
	case EEPROM_STEREODATA_MT_MAIN_105CM:
		read_yamahamain_eeprom_info(ctx, EEPROM_META_STEREO_MT_MAIN_DATA_105CM,
				(BYTE *)feature_return_para_32, *len);
		break;
	case EEPROM_STEREODATA_MW_MAIN:
	default:
		read_yamahamain_eeprom_info(ctx, EEPROM_META_STEREO_MW_MAIN_DATA,
				(BYTE *)feature_return_para_32, *len);
		break;
	}
	return 0;
...
static bool read_cmos_eeprom_p8(struct subdrv_ctx *ctx, kal_uint16 addr,
                    BYTE *data, int size)
{
	if (adaptor_i2c_rd_p8(ctx->i2c_client, YAMAHAMAIN_EEPROM_READ_ID >> 1,
			addr, data, size) < 0) {
		return false;
	}
	return true;
...
{
	DRV_LOGE(ctx, "yamahamain read_otp_info begin\n");
	read_cmos_eeprom_p8(ctx, 0, otp_data_checksum, OTP_SIZE);
	DRV_LOGE(ctx, "yamahamain read_otp_info end\n");
}
...
static u16 yamahamain_feedback_awbgain[] = {
	0x0B8E, 0x01,
	0x0B8F, 0x00,
	0x0B90, 0x02,
	0x0B91, 0x28,
...
static void feedback_awbgain(struct subdrv_ctx *ctx, kal_uint32 r_gain, kal_uint32 b_gain)
{
	...
	if (ctx->current_scenario_id == SENSOR_SCENARIO_ID_CUSTOM5 ||
		...
		ctx->current_scenario_id == SENSOR_SCENARIO_ID_CUSTOM10 ||
		...
		yamahamain_feedback_awbgain[5] = r_gain_int;
		yamahamain_feedback_awbgain[7] = (r_gain - r_gain_int * 512) / 2;
		yamahamain_feedback_awbgain[9] = b_gain_int;
		yamahamain_feedback_awbgain[11] = (b_gain - b_gain_int * 512) / 2;
		subdrv_i2c_wr_regs_u8(ctx, yamahamain_feedback_awbgain,
			ARRAY_SIZE(yamahamain_feedback_awbgain));
	}
}
...
void yamahamain_get_min_shutter_by_scenario(struct subdrv_ctx *ctx,
		enum SENSOR_SCENARIO_ID_ENUM scenario_id,
...
int yamahamain_get_min_shutter_by_scenario_adapter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	u64 *feature_data = (u64 *) para;
	yamahamain_get_min_shutter_by_scenario(ctx,

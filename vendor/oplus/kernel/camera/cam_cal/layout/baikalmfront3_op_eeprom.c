...
#define PFX "CAM_CAL_BAIKALMFRONT3"
...
static unsigned int do_single_lsc_baikalmfront3(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_baikalmfront3(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_baikalmfront3(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x01C40055, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000530, 0x0000074C, do_single_lsc_baikalmfront3},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_baikalmfront3},  //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_baikalmfront3}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT baikalmfront3_op_eeprom = {
	.name = "baikalmfront3_op_eeprom",

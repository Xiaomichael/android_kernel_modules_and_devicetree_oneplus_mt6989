...
int panel_id_read(struct drm_crtc *crtc)
{
	...
	char switch_default_page_vdo[5] = {0xFF, 0xAA, 0x55, 0xA5, 0x00};
	char switch_subaru_default_page[6] = {0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00};
	...
	if (!(strcmp(panel_name, "aa600_p_3_a0025_vdo_panel")
			&& strcmp(panel_name, "aa600_p_7_a0025_vdo_panel")
			&& strcmp(panel_name, "aa597_p_3_a0025_dsi_vdo")
			&& strcmp(panel_name, "aa597_p_7_a0025_dsi_vdo"))) {
		oplus_ddic_dsi_send_cmd(5, switch_subaru_default_page);
		oplus_mtk_read_ddic_v2(0xDA, 5, para);
		m_da = para[0] & 0xFF;
...
int panel_serial_number_read(struct drm_crtc *crtc, char cmd, int num)
{
	...
	if (!strcmp(panel_name, "ac158_p_b_a0012_cmd_panel")
		|| !strcmp(panel_name, "ac234_p_b_a0012_cmd_panel")) {
		para[0] = 0x00;
	}

...
enum oplus_ofp_property_value {
	...
	OPLUS_OFP_PROPERTY_DIMLAYER_AND_PRESSICON = BIT(0)|BIT(1),
...
#define AE174_ELVSS_READ_RETRY_MAX 5
#define AE174_ELVSS_READ_LENGTH 1
#define AE174_ELVSS_READ_REG 0xB5
#define AC178_ELVSS_REG_INDEX 0

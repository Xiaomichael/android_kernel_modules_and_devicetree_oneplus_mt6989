...
#define TEMP_LOG_TEMPLATE \
	"ndevdrp:%s NAPI[%lu,%lu,0x%03lx,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu] " \
	NAPI_DELAY_TEMPLATE \
	RRO_LOG_TEMPLATE \
	"RxReorder[%s] " \
	RX_PENDING_TEMPLATE \
	RRB_TRACK_TEMPLATE \
	"drv[RM,IL,RI,RIE,PA,PF,DU,DA,RT,RM,RW,RA,RB,DT,NS," \
...
/* switch pcie gen */
//ifdef OPLUS_FEATURE_DYNAMIC_PCIE_GEN_SWITCH
/*
#if CFG_SUPPORT_PCIE_GEN_SWITCH
		kalSetPcieGen(prAdapter);
#endif
*/
//endif OPLUS_FEATURE_DYNAMIC_PCIE_GEN_SWITCH

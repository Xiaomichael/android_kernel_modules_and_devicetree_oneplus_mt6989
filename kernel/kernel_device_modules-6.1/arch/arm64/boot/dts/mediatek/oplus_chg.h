...
#define OPLUS_CHG_IC_REVERSE		30
#define OPLUS_CHG_IC_VIRTUAL_REVERSE	31
...
#define OPLUS_IC_FUNC_BUCK_GET_BYB_STATUS		(OPLUS_IC_FUNC_NUM_BUCK_START + 50)
#define OPLUS_IC_FUNC_BUCK_GET_BYB_VOUT 		(OPLUS_IC_FUNC_NUM_BUCK_START + 51)
#define OPLUS_IC_FUNC_BUCK_SET_BYB_VOUT 		(OPLUS_IC_FUNC_NUM_BUCK_START + 52)
#define OPLUS_IC_FUNC_BUCK_ITEM_CHECK			(OPLUS_IC_FUNC_NUM_BUCK_START + 53)
#define OPLUS_IC_FUNC_BUCK_GET_POWER_ROLE 		(OPLUS_IC_FUNC_NUM_BUCK_START + 54)
...
#define OPLUS_IC_FUNC_CP_GET_REVERSE_VOUT			(OPLUS_IC_FUNC_NUM_CP_START + 20)
...
#define OPLUS_IC_FUNC_BUCK_GET_SHAFT_BATT_BTB_TEMP	(OPLUS_IC_FUNC_NUM_MISC_START + 32)
#define OPLUS_IC_FUNC_BUCK_PUSH_SHAFT_BATT_BTB_OVER	(OPLUS_IC_FUNC_NUM_MISC_START + 33)
#define OPLUS_IC_FUNC_GET_SOURCE_PDO			(OPLUS_IC_FUNC_NUM_MISC_START + 34)
...
/* reverse */
#define OPLUS_IC_FUNC_NUM_REVERSE_SEC_START		1400
#define OPLUS_IC_FUNC_GET_REVERSE_ENABLE 		(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 0)
#define OPLUS_IC_FUNC_SET_REVERSE_SRC_PDO 		(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 1)
#define OPLUS_IC_FUNC_GET_REVERSE_CHG_SVID 		(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 2)
#define OPLUS_IC_FUNC_GET_HIGH_REVERSE_ENABLE 		(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 3)
#define OPLUS_IC_FUNC_REVERSE_CHG_WDT_ENABLE 		(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 4)
#define OPLUS_IC_FUNC_REVERSE_CHG_KICK_WDT 		(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 5)
#define OPLUS_IC_FUNC_GET_RVS_CHG_MSG			(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 6)
#define OPLUS_IC_FUNC_GET_SINK_REQ_PDO			(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 7)
#define OPLUS_IC_FUNC_RVS_SET_HIGH_PWR_MODE_EN 		(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 8)
#define OPLUS_IC_FUNC_GET_REVERSE_CHG_TYPE 		(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 9)
#define OPLUS_IC_FUNC_GET_SOURCE_PLUG_OUT 		(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 10)
#define OPLUS_IC_FUNC_SET_NORMAL_REVERSE_HW_OCP 	(OPLUS_IC_FUNC_NUM_REVERSE_SEC_START + 11)
...
#define OPLUS_IC_VIRQ_HMAC_UPDATE		24
#define OPLUS_IC_VIRQ_POWER_ROLE_STATUS		25
#define OPLUS_IC_VIRQ_REVERSE_ENABLE		26
#define OPLUS_IC_VIRQ_HIGH_REVERSE_ENABLE	27
#define OPLUS_IC_VIRQ_SINK_REQ_MSG		28

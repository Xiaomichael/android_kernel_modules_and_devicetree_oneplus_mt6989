...
#define OV50D40_I2C_SLAVE_ADDR             (0x10)
...
#define OV50D40_I2C_MAX_FREQUENCY          (1000000)
			       ...
			       int num, int left_num)
{
	...
	if ((msgs->addr == FG_DEVICE_ADDR || msgs->addr == CHARGE_PUMP_HL7138_DEVICE_ADDR ||
		msgs->addr == CHARGE_PUMP_SC8547_DEVICE_ADDR ||
		msgs->addr == CHARGE_PUMP_SC8547D_DEVICE_ADDR) &&
...
static void olus_changeI2cSpeed(struct mtk_i2c *i2c, struct i2c_msg msgs[])
{
    ...
    if ((project == 23265)&& (i2c->adap.nr == 2)) {
        ...
        mtk_i2c_writew(i2c, i2c->ltiming_reg, OFFSET_LTIMING);
                ...
                || project == 24705 || project == 24706 || project == 24608
        ...
        mtk_i2c_writew(i2c, i2c->high_speed_reg, OFFSET_HS);
        mtk_i2c_writew(i2c, i2c->ltiming_reg, OFFSET_LTIMING);
	} else if ((project == 24780 || project == 24781 || project == 24626 || project == 25677) && (i2c->adap.nr == 2)) {
        if (msgs[0].addr == OV50D40_I2C_SLAVE_ADDR) {
            i2c->speed_hz = OV50D40_I2C_MAX_FREQUENCY;
        } else {
            i2c->speed_hz = I2C_MAX_FREQUENCY;
        }
        ret = mtk_i2c_set_speed(i2c,PARENT_CLK);
...
static int mtk_i2c_parse_dt(struct device_node *np, struct mtk_i2c *i2c)
{
	...
	dev_info(i2c->dev, "fifo-use-polling=%d, request-cpu-qos=%d\n",
			 i2c->fifo_use_polling, i2c->request_cpu_qos);

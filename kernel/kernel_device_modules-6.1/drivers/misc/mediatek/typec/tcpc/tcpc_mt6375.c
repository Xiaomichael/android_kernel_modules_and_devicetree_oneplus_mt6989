...
__maybe_unused static int mt6375_init_power_status_mask(struct mt6375_tcpc_data *ddata)
{
	return mt6375_write8(ddata, TCPC_V10_REG_POWER_STATUS_MASK, 0);
}

__maybe_unused static int mt6375_init_fault_mask(struct mt6375_tcpc_data *ddata)
{
	return mt6375_write8(ddata, TCPC_V10_REG_FAULT_STATUS_MASK,
			     TCPC_V10_REG_FAULT_STATUS_VCONN_OC);
}

__maybe_unused static int mt6375_init_ext_mask(struct mt6375_tcpc_data *ddata)
{

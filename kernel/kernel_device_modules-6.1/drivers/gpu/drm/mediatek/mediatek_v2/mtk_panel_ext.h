...
//Settings for LFR Function:
	...
	*/
	...
	bool before_power_down;
	bool vdo_mix_mode_en;
	bool set_backlight_delay;
};
...
struct mtk_panel_funcs {
	...
	int (*set_seed)(void *dsi_drv, dcs_write_gce cb, void *handle, unsigned int mode);
	...
	void (*lcm_high_pwm_set_plus)(void *dsi, dcs_write_gce cb, void *handle, unsigned int bl_lvl);
	...
	int (*update_te_time)(void);
	int (*lcm_set_hbm_max)(void *dsi, dcs_write_gce_pack cb1, dcs_write_gce cb2, void *handle, unsigned int en);
	...
	int (*set_backlight_pack)(void *dsi_drv, dcs_write_gce_pack cb1,
		void *handle, unsigned int level);
	...
	int (*oplus_ofp_set_lhbm_pressed_icon)(struct drm_panel *panel, void *dsi_drv, dcs_write_gce_pack cb, void *handle, bool lhbm_pressed_icon_on);

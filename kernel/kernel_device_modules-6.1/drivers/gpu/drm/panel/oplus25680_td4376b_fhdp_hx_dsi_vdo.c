...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x2e, 0x0b);
    lcm_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x2f, 0x54);
    lcm_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x30, 0x11);
    lcm_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x31, 0x94);
    lcm_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x32, 0x15);
    lcm_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x33, 0x7c);
    lcm_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x34, 0x17);
    lcm_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x35, 0xe8);
    lcm_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x36, 0x19);
    lcm_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x37, 0x32);
    ...
    lcm_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x11, 0xdb);
